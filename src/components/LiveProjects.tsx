...
const LiveProjects = () => {
  const projects = [
    ...
    },
    {
      ...
      budget: '$3,200',
      timeline: '6 weeks',
      description: 'iOS/Android app with workout tracking, progress analytics, and social features.',
    ...
    },
    {
      ...
      budget: '$2,800',
      timeline: '5 weeks',
      description: 'Data visualization dashboard with real-time metrics and reporting features.',
    ...
    },
    {
      ...
      budget: '$4,500',
      timeline: '8 weeks',
      description: 'Decentralized marketplace for NFT trading with smart contract integration.',
  ...
  const getUrgencyColor = (urgency: string) => {
    switch (urgency) {
      ...
      default: return 'text-writeforge-gray bg-writeforge-gray/10';
    }
  };
