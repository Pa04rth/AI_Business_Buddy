          ...
          const mockProjects = [
            {
              ...
              description:
                "Content creation for spring marketing campaign including blog posts, social media content, and email newsletters.",
              type: "Marketing",
              status: "In Progress",
            ...
            },
            {
              ...
              description:
                "Comprehensive content strategy for new product launch including press releases, feature descriptions, and user guides.",
              type: "Product",
              status: "Completed",
            ...
            },
            {
              ...
              description:
                "Monthly blog post series focused on industry trends and SEO optimization.",
              type: "Blog",
              status: "Draft",
            ...
            },
            {
              ...
              description:
                "Reusable social media content templates for various platforms and campaigns.",
              type: "Social Media",
              status: "In Progress",
            ...
            <div>
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {projects.map((project, index) => (
                    ...
                    >
                      ...
                      <p className="text-writeforge-gray text-sm mb-4 line-clamp-3">
                        {project.description}
                      </p>
                ...
                <div className="text-center py-20">
                  <FileText
                    size={64}
                    className="text-writeforge-gray mx-auto mb-4"
                  />
                  <h3 className="text-white text-xl font-semibold mb-2">
                    No projects yet
                  </h3>
